...
\addbibresource{cartpole_swingup.bib}
...
\input{input/system_description}
\input{input/experimental_setup}
% \input{input/results_and_discussion}
% \input{input/conclusion_and_future_work}
