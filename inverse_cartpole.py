...
model_name = "PPO_CartPoleEnv2_10k_smoothing_error_protection_reward_simple_2step_faster_lessweight_51actions_" + datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
